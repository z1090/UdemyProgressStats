...
const statsGenerator = (startDateStr, progress, webpageContent, callback) => {
    ...
    const daysTaken = Math.floor((todayMils - startDateMils) / 3600000 / 24);
    
    const estimatedDays = Math.ceil((daysTaken / percentComplete) * 100);
    ...
    const courseInfo = {
        ...
        daysLeft: estimatedDays - daysTaken,
